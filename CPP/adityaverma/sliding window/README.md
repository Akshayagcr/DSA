Question: we are given an array of integers and a subarray size k we need to find a subarray of size k with maximum sum
...
Optimised approach : instead of every time summing the window we just need to substract first element and add new element 
